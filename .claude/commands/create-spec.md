---
description: Create a spec file for the next Spendly feature argument-hint: "Step number and feature
...
## Depends on Which previous steps this feature requires to be complete.
## Routes
...
## Rules for implementation Specific constraints Claude must follow.
Always include:
# Spec: <feature_title>
...
Do not print full spec in the chat unless explicitly asked
